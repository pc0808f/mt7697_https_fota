...
#define ORI_LENGTH              0xC1000       /* 772KB */
#define FOTA_LENGTH             0xC1000       /* 772KB */
#define EXTBL_LENGTH            0x8000        /*  32KB */
...
#define ORI_BASE                (CM4_CODE_BASE   + CM4_CODE_LENGTH)
#define FOTA_BASE               (ORI_BASE        + ORI_LENGTH)
#define EXTBL_BASE              (FOTA_BASE       + FOTA_LENGTH)
#define NVDM_BASE               (EXTBL_BASE      + EXTBL_LENGTH)
